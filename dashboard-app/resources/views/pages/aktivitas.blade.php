                ...
                <form id="sessionForm" class="space-y-6">
                    ...
                    <div>
                        ...
                        <select id="makanan" class="activity-field activity-select">
                            ...
                            <!-- NASI -->
                            <option>Nasi Putih</option>
                            <option>Nasi Merah</option>
                            <option>Nasi Hitam</option>
                            <option>Nasi Kuning</option>
                            <option>Nasi Uduk</option>
                            <option>Nasi Liwet</option>
                            <option>Nasi Goreng</option>
                            <option>Nasi Padang</option>
                            <option>Nasi Pecel</option>
                            <option>Nasi Campur</option>
                            <option>Nasi Bakar</option>
                            <option>Nasi Hainan</option>

                            <!-- UMBI -->
                            <option>Singkong Rebus</option>
                            <option>Singkong Goreng</option>
                            <option>Ubi Jalar</option>
                            <option>Kentang Rebus</option>
                            ...
                            <option>Ayam Kecap</option>
                            <option>Ayam Rica-Rica</option>
                            <option>Ayam Gulai</option>
                            <option>Sate Ayam</option>

                            <!-- IKAN -->
                            <option>Ikan Bakar</option>
                            <option>Ikan Goreng</option>
                            <option>Lele Goreng</option>
                            <option>Patin Bakar</option>
                            <option>Bandeng Bakar</option>
                            <option>Tuna Panggang</option>
                            <option>Salmon Panggang</option>
                            <option>Sarden</option>

                            <!-- DAGING -->
                            <option>Daging Sapi</option>
                            <option>Rendang</option>
                            <option>Semur Daging</option>
                            <option>Empal</option>
                            <option>Steak Sapi</option>
                            <option>Bakso Daging</option>
                            <option>Sate Sapi</option>

                            <!-- TELUR -->
                            <option>Telur Rebus</option>
                            <option>Telur Dadar</option>
                            <option>Telur Ceplok</option>
                            <option>Telur Balado</option>
                            <option>Telur Asin</option>

                            <!-- SAYUR -->
                            <option>Sayur Bayam</option>
                            <option>Sayur Asem</option>
                            <option>Sayur Sop</option>
                            <option>Capcay</option>
                            <option>Tumis Kangkung</option>
                            ...
                            <option>Mie Goreng</option>
                            <option>Mie Rebus</option>
                            <option>Mie Ayam</option>
                            <option>Bakmi Jawa</option>
                            <option>Bihun Goreng</option>
                            ...
                            <option>Keripik Kentang</option>
                            <option>Biskuit</option>
                            <option>Wafer</option>
                            <option>Coklat Batang</option>
                            <option>Permen</option>

                            <!-- MINUMAN / DESSERT -->
                            <option>Es Krim Vanilla</option>
                            <option>Es Krim Coklat</option>
